...
public class AStarState
{
    ...
    private HashMap<Location, Waypoint> openedVertex = new HashMap<Location, Waypoint>(); //хранит в себе хеш значения определенного поля, пустая коллекция
    ...
    public boolean addOpenWaypoint(Waypoint newWP)
    {
        ...
        if (compare.getPreviousCost() > newWP.getPreviousCost()) {
            openedVertex.put(newWP.getLocation(), newWP); //если путь короче, то новая точка
            return true;
        }
        return false;
    }
